...
<?php $selectedPanel = $selectedPanel ?? 'register'; ?>
<?php include __DIR__ . '/../admin/navigation.php'; ?>
    <section class="space-y-6">
        <?php if (!empty($errors)): ?>
            <div class="rounded-3xl bg-rose-50 border border-rose-200 p-5 text-rose-700">
        ...
        <article class="rounded-3xl bg-white p-8 shadow-2xl border border-slate-200">
