                ...
                <div id="login-card" class="rounded-3xl bg-slate-50 p-6 shadow-inner border border-slate-200">
                    ...
                    <form method="post" action="index.php?controller=Auth" class="mt-5 space-y-4">
                        ...
                        <label class="block">
                            ...
                            <input type="email" name="correo" value="<?php echo htmlspecialchars($old['correo'] ?? ''); ?>" class="mt-2 w-full rounded-3xl border border-slate-300 bg-white px-4 py-3 focus:border-sky-500 focus:outline-none" placeholder="correo@dominio.com" required>
                        </label>
